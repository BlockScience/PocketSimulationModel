...
validator_stake_space = TypedDict(
...
modify_validator_pokt_space = TypedDict(
...
validator_param_update_space = TypedDict(
...
validator_pause_space = TypedDict(
...
validator_block_reward_space = TypedDict(
    "Validator Block Reward Space",
    {
        "public_key": PublicKeyType,  # The public cryptographic id of the validator account
