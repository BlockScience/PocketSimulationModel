...
burn_pokt_mechanism_space = TypedDict(
    "Burn POKT Mechanism Space", {"burn_amount": uPOKTType}
)

mint_block_rewards_space = TypedDict(
...
distribute_fees_space = TypedDict(
...
burn_pokt_space = TypedDict(
    "Burn POKT Space", {"burn_amount": uPOKTType, "block_height": BlockHeightType}
)
jail_node_space = TypedDict(
    "Jail Node Space",
    {
...
increase_relay_fees_space = TypedDict(
    "Increase Relay Fees Space",
    {
        "POKT Amount": uPOKTType,
    },
)
decrease_relay_fees_space = TypedDict(
