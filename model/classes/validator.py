...
class Validator:
    ...
    def __init__(self, name: str, pokt_holdings: uPOKTType,
                 staked_pokt: uPOKTType, service_url: ServiceURLType,
                 operator_public_key: PublicKeyType, stake_status: StakeStatusType):
        self.name = name
